---
description: Definitions of Claude Code subagents for delegation.
scope: local-agents
prerequisites: none
---
# Claude Code Subagents

<instructions role="assistant" scope="local-agents">
...
-   **Location:** Project agents live under `.claude/agents/`.
-   **Format:** Markdown with YAML frontmatter (see files for examples).
-   **Shell:** Windows, prefer PowerShell (pwsh). Avoid bash-only commands.
