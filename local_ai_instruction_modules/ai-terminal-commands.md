---
description: Local cheat sheet for terminal commands and automation tools.
scope: local-terminal
prerequisites: none
---
# Terminal Commands Cheat Sheet (pwsh-first)

<instructions role="assistant" scope="local-terminal">
...
- **Priority:** Prefer automation via MCP tools, terminal commands next, then GitHub API calls last.
</overview>
