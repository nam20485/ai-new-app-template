---
description: Local index of active dynamic workflows from the remote canonical repository.
scope: local-dynamic-workflows
prerequisites: none
---
# Dynamic Workflows Index

<instructions role="assistant" scope="local-dynamic-workflows">
